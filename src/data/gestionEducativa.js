export const gestionEducativa = [
    {   id: 1, name: 'Entrega de kits escolares para los asociados de Alagro.', 
        ...
        desc: [
            ...
            'Más que útiles, entregamos tranquilidad, respaldo y oportunidades. Porque cuando un niño empieza clases con lo necesario, empieza el año con confianza; y cuando apoyamos la educación, sembramos el futuro del campo.',
    ...
    {   id: 2, name: 'Subsidio de transporte escolar – Apoyo a las familias rurales.', 
        ...
        desc: [
            ...
            'Por eso, a través de nuestro programa solidario, brindamos un subsidio de pasajes y transporte para los hijos y nietos de asociados, ayudando a que puedan desplazarse a sus instituciones educativas de forma más segura y accesible.',
            'Este apoyo alivia la economía del hogar y garantiza que ningún niño o joven deje de estudiar por falta de recursos. Porque cuando facilitamos el camino a la escuela, abrimos el camino a sus sueños.',
    ...
    {   id: 3, name: 'Capacitación para el talento humano de nuestros empleados y asociados.', 
        ...
        desc: [
            ...
            'Invertir en el talento humano es invertir en calidad, eficiencia y confianza. Porque cuando nuestro equipo aprende, toda la cooperativa avanza.',
    ...
    {   id: 4, name: 'Bachillerato en Casa – Educación para nuestros productores.', 
        ...
        desc: [
            ...
            'Gracias a esta iniciativa, ya celebramos dos promociones de asociados graduados, hombres y mujeres que demostraron que la educación también hace parte del progreso rural. Hoy cuentan con más herramientas para administrar mejor sus proyectos productivos, tomar decisiones informadas y abrir nuevas oportunidades para ellos y sus familias.',
            'Porque el conocimiento dignifica, empodera y transforma generaciones. En ALAGRO, no sólo fortalecemos el campo: también fortalecemos a las personas.'
        ]
    },
];